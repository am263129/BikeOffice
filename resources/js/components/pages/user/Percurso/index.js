            ...
            <div className="p-5 text-black bg-white rounded-lg relative max-w-7xl m-auto">
                ...
                <div className="lg:flex justify-between grid grid-cols-1 grid-rows-2 items-baseline">
                    <h5 className="text-lg mt-3">
                        ...
                        Veja o resumo do percurso:{" "}
                    </h5>
                    <div className="w-full justiry-around gap-5 grid grid-cols-1  md:flex justify-between lg:justify-end">
                        <PrimaryButton
                ...
                <div className="lg:flex ">
                    ...
                    <div className="flex flex-col justify-between pb-5 mt-10">
                        <div className="lg:flex justify-between grid grid-cols-1 gap-10">
                            <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-rows-3 gap-4">
                                <div className="flex items-center gap-2">
                                    ...
                                    <div className="flex flex-col w-3/4">
                                        ...
                                        <h4 className="text-primary-dark text-lg font-bold">
                                            {course.start !== null
                                                ? course.start
                                                : ""}
                                        </h4>
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <div className="flex flex-col w-3/4">
                                        ...
                                        <h4 className="text-primary-dark text-lg font-bold">
                                            {course.turns ? course.turns : ""}
                                        </h4>
                                    </div>
                                </div>
                            </div>
                            <div className={`grid md:grid-cols-2 grid-cols-1 gap-5 ${tab===3&&"hidden"}`}>
                                <div className="flex gap-5">
                                    ...
                                    <div>
                                        ...
                                        <h5 className="text-primary-dark font-bold">
                                            {course.predominant}
                                        </h5>
                                    </div>
                                </div>
                ...
                <div>
                            ...
                            <div className="w-full lg:grid-cols-4 grid-cols-1 grid text-primary-dark">
                                <h4 className="col-start-2 ">
                                    ...
                                    <span className="font-bold">
                                        ALERT:Zona com major declive procure
                                        descansar de segulda.
                                    </span>
                                </h4>
                            </div>
                    ...
                    {tab == 3 && (
                        <div className="flex  flex-col lg:flex-row justify-between gap-4 p-5">
                            <div className="flex gap-5 flex-col min-w-64 justify-center w-full md:w-2/5  max-w-md">
                            ...
                            <div className="lg:w-3/5 w-full ">
                                <img
                                    src={`${serverUrl}/resource/courses/${course.courseName}/${course.routeImage}`}
                                    className="w-full"
                                />
                            </div>
                        </div>
